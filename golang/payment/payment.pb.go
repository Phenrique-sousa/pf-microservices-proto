...
const file_payment_payment_proto_rawDesc = "" +
	...
	"\n" +
	"payment_id\x18\x01 \x01(\x03R\tpaymentId2D\n" +
	"\aPayment\x129\n" +
	"\x06Create\x12\x15.CreatePaymentRequest\x1a\x16.CreatePaymentResponse\"\x00BBZ@github.com/phenrique-sousa/pf-microservices-proto/golang/paymentb\x06proto3"
